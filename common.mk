...
TARGET_BOOTANIMATION_INTRO := $(COMMON_PATH)/bootanimation
...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(COMMON_PATH)/nfc,$(TARGET_COPY_OUT_VENDOR)/etc)
...
# Init
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(COMMON_PATH)/init/vendor,$(TARGET_COPY_OUT_VENDOR))
